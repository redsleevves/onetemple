...
<script>
    ...
    let arr = ["大智山玄空法寺", "壽山巖觀音寺", "麥寮拱範宮", "台中草屯雷藏寺", "佛光山寺", "松山慈惠堂", "台灣護聖宮", 
               "北港朝天宮", "台北松山慈祐宮", "台中大甲鎮瀾宮", "法鼓山", "南鯤鯓代天府", "正統鹿耳門聖母廟", "鹿港天后宮", 
               "臺東天后宮", "高雄代天宮", "松山奉天宮", "鹿港龍山寺", "日月潭文武廟", "台北行天宮", "高雄玉皇宮", "萬華龍山寺", 
               "三峽清水祖師廟", "長春路四面佛", "霞海城隍廟", "新竹都城隍廟", "台北林神農宮", "台北芝山聖佑宮", "台北大龍峒保安宮", 
               "台北關渡宮", "頭城慶元宮", "鹿港興安宮", "二林仁和宮", "鹿耳門天后宮", "山上天后宮", "茅港尾堡天后宮",
              "南投市配天宮", "新屋天后宮", "新港奉天宮", "崙背奉天宮", "旗山天后宮", "六堆天后宮", "澎湖天后宮"]
