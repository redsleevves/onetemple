    ...
    <div class="shop_top100 shop_container container-fluid">
        ...
        <div class="shop_phone_button">
            ...
            <select class="shop_phone_btn">
                ...
                <option value="2" data-p="Categories=線香">線香</option>
                <option value="3" data-p="Categories=飾品">飾品</option>
                <option value="4" data-p="Categories=擺飾">服飾</option>
                <option value="5" data-p="Categories=平安符">平安符</option>
                <option value="6" data-p="Joint_Popular=聯名合作">聯名合作</option>
                <option value="7" data-p="Joint_Popular=熱門商品">熱門商品</option>
            </select>
